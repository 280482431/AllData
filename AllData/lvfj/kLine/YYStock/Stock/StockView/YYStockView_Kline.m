...
//    [YYStockVariable setLineWith:(self.stoc                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ®kScrollView.bounds.size.width / lineModels.count) - [YYStockVariable lineGap]];
    [self layoutIfNeeded];
...
- (void)drawLeftDesc {
    ...
    CGSize textSize2 = [self rectOfNSString:[result firstObject] attribute:attribute].size;
    [[result firstObject] drawInRect:CGRectMake(YYStockScrollViewLeftGap - textSize2.width - 5, YYStockScrollViewTopGap + self.stockScrollView.frame.size.height * (1 - [YYStockVariable volumeViewRadio]), 60, 20) withAttributes:attribute];
    CGSize textSize1 = [self rectOfNSString:[result lastObject] attribute:attribute].size;
    [[result lastObject] drawInRect:CGRectMake(YYStockScrollViewLeftGap - textSize1.width - 5, YYStockScrollViewTopGap + 15 + self.stockScrollView.frame.size.height * (1 - [YYStockVariable volumeViewRadio]), 60, 20) withAttributes:attribute];
}
...
//    NSInteger drawLineCount = self.lineModels.count;
