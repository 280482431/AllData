...
//        CGFloat unitHeight = (self.frame.size.height*[YYStockVariable lineMainViewRadio]);
//        [self drawLineWithHeight:unitHeight contextRef:ctx];
        
        CGFloat unitHeight = [[lvfjHelper getUserDefaultsObjForKey:kTimeLinePrevCloseHeight] floatValue];
        [self drawLineWithHeight:unitHeight contextRef:ctx];
        
        CGContextClosePath(ctx);
//        unitHeight = YYStockLineMainViewMinY;
//        [self drawLineWithHeight:unitHeight contextRef:ctx];
        
//        CGFloat lineMaxY = YYStockLineVolumeViewMinY;
...
-(void)drawLineWithHeight:(CGFloat)unitHeight contextRef:(CGContextRef)ctx{
    //颜色
