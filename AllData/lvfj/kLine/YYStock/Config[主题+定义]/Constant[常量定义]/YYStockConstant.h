 ...
 *  K线图上可画区域最小的Y
 */
#define YYStockLineMainViewMinY 0

/**
 *  K线图的成交量上最小的Y
 */
#define YYStockLineVolumeViewMinY 0

/**
 *  K线图的成交量下面日期高度
 */
#define YYStockLineDayHeight 10
 ...
 *  K线ScrollView距离顶部的距离
 */
#define YYStockScrollViewTopGap 3
 ...
 */
#define YYStockTimeLineViewLeftGap 5
