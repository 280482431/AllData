...
#define kTimeLinePrevCloseHeight  @"kTimeLinePrevCloseHeight"
#define kTimeLinePrevClose  @"kTimeLinePrevClose"
#define kTimeLineTotleCount @"kTimeLineTotleCount"
#define kTimeLineTimes @"kTimeLineTimes"
